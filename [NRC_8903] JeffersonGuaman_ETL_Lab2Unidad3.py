...
def load():
    ...
    try:
        log(logfile, "-------------------------------------------------------------")
        log(logfile, "Inicia el Proceso de Carga")
        ...
        cursor = conn.cursor()
        log(logfile, "Finaliza el Proceso de Carga")
        log(logfile, "-------------------------------------------------------------")
...
def extract():
    log(logfile, "--------------------------------------------------------")
    log(logfile, "Inicia el Proceso de Extraccion")
    metadata = MetaData()
    metadata.create_all(engine)
    log(logfile, "Finaliza el Proceso de Extraccion")
    log(logfile, "--------------------------------------------------------")
